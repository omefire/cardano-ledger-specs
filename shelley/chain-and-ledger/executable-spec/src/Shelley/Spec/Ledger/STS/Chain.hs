...
import Cardano.Protocol.TPraos.BHeader (BHeader, LastAppliedBlock (..), bHeaderSize, bhHash, bhbody, bheaderBlockNo, bheaderSlotNo, hBbsize, lastAppliedHash, prevHashToNonce)
